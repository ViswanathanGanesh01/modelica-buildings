...
model HeatPump_OnOff "Motor coupled heat pump"
  ...
  Modelica.Blocks.Interfaces.BooleanInput u annotation (Placement(
        transformation(extent={{-130,-16},{-100,14}}), iconTransformation(
          extent={{-130,-16},{-100,14}})));
protected
...
<p>This is a model of a squirrel cage induction motor coupled heat pump with ideal speed control that has an overide boolean control. The model has electrical interfaces and can be used for simulating microgrids and discussing grid interactions. </p>
</html>", revisions="<html>
<ul>
